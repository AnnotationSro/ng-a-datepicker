  ...
  'overrides': [
    {
      ...
      'rules': {
        '@angular-eslint/directive-selector': ['warn', {'type': 'attribute', 'prefix': ['ngDate'], 'style': 'camelCase'}],
        '@angular-eslint/component-selector': ['warn', {'type': 'element', 'prefix': ['ng-date'], 'style': 'kebab-case'}],
